...
namespace BlogCore.AccesoDatos.Migrations
{
    ...
    [Migration("20250603180519_Migracion Nueva")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlogCore.Models.Carrito", b =>
                {
                    b.Property<int>("carrito_id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("carrito_id"));

                    b.Property<string>("IdentityUserId")
                        .HasColumnType("nvarchar(450)")
                        .HasColumnName("carrito_usuarioId");

                    b.Property<DateTime>("carrito_fechaCreacion")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("BlogCore.Models.CarritoCompra", b =>
                {
                    b.Property<int>("carritoCompra_id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("carritoCompra_id"));

                    b.Property<int>("Carritocarrito_id")
                        .HasColumnType("int")
                        .HasColumnName("carritoCompra_carritoId");

                    b.Property<int>("Productoproducto_id")
                        .HasColumnType("int")
                        .HasColumnName("carritoCompra_productoId");

                    b.Property<int>("carritoCompra_cantidad")
                        .HasColumnType("int");

                    b.Property<DateTime>("carritoCompra_creacion")
                        .HasColumnType("datetime2");

                    b.Property<Guid>("carritoCompra_guid")
                        .HasColumnType("uniqueidentifier");

                    b.Property<DateTime>("carritoCompra_modificacion")
                        .HasColumnType("datetime2");

                    b.HasKey("carritoCompra_id");

                    b.HasIndex("Carritocarrito_id");
            ...
            modelBuilder.Entity("BlogCore.Models.ComentarioProducto", b =>
                {
                    b.Property<int>("comentarioProducto_id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("comentarioProducto_id"));

                    b.Property<int?>("ComentarioProductocomentarioProducto_id")
                        .HasColumnType("int")
                        .HasColumnName("comentarioProducto_CmtProductFkID");

                    b.Property<int>("Productoproducto_id")
                        .HasColumnType("int")
                        .HasColumnName("comentarioProducto_productoId");

                    b.Property<string>("comentarioProducto_descripcion")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime>("comentarioProducto_fechaCreacion")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("comentarioProducto_fechaModificacion")
                        .HasColumnType("datetime2");

                    b.Property<Guid>("comentarioProducto_guid")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("comentarioProducto_nombrePublicador")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("comentarioProducto_id");

                    b.HasIndex("ComentarioProductocomentarioProducto_id");

                    b.HasIndex("Productoproducto_id");

                    b.ToTable("ComentarioProducto");
                });
            ...
            modelBuilder.Entity("BlogCore.Models.CarritoCompra", b =>
                {
                    b.HasOne("BlogCore.Models.Carrito", "carrito")
                        .WithMany("carritoCompra")
                        .HasForeignKey("Carritocarrito_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BlogCore.Models.ComentarioProducto", b =>
                {
                    b.HasOne("BlogCore.Models.ComentarioProducto", "comentarioProductoFK")
                        .WithMany("listadoComentarioProductos")
                        .HasForeignKey("ComentarioProductocomentarioProducto_id")
                    ...
                    b.Navigation("comentarioProductoFK");
            ...
            modelBuilder.Entity("BlogCore.Models.ComentarioProducto", b =>
                {
                    b.Navigation("listadoComentarioProductos");
                });
