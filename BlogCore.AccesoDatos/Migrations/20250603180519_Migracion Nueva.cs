    ...
    public partial class MigracionNueva : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    carrito_id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    carrito_sessionId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    carrito_fechaCreacion = table.Column<DateTime>(type: "datetime2", nullable: false),
                    carrito_fechaModificacion = table.Column<DateTime>(type: "datetime2", nullable: false),
                    carrito_precioTotal = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    carrito_usuarioId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Carrito", x => x.carrito_id);
                    table.ForeignKey(
                        name: "FK_Carrito_AspNetUsers_carrito_usuarioId",
                        column: x => x.carrito_usuarioId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    carritoCompra_id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    carritoCompra_guid = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    carritoCompra_cantidad = table.Column<int>(type: "int", nullable: false),
                    carritoCompra_creacion = table.Column<DateTime>(type: "datetime2", nullable: false),
                    carritoCompra_modificacion = table.Column<DateTime>(type: "datetime2", nullable: false),
                    carritoCompra_productoId = table.Column<int>(type: "int", nullable: false),
                    carritoCompra_carritoId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarritoCompra", x => x.carritoCompra_id);
                    table.ForeignKey(
                        name: "FK_CarritoCompra_Carrito_carritoCompra_carritoId",
                        column: x => x.carritoCompra_carritoId,
                        principalTable: "Carrito",
                        principalColumn: "carrito_id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CarritoCompra_Producto_carritoCompra_productoId",
                        column: x => x.carritoCompra_productoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Carrito_carrito_usuarioId",
                table: "Carrito",
                column: "carrito_usuarioId");

            migrationBuilder.CreateIndex(
                name: "IX_CarritoCompra_carritoCompra_carritoId",
                table: "CarritoCompra",
                column: "carritoCompra_carritoId");

            migrationBuilder.CreateIndex(
                name: "IX_CarritoCompra_carritoCompra_productoId",
                table: "CarritoCompra",
